...
describe("tenant quota window helpers", () => {
  it("uses an exact UTC minute for gateway evaluations and an exact UTC day for exports", () => {
  ...
  it("maps each usage category to its distinct tenant-owned limit", () => {
    const quotas = { gatewayEvaluationsPerMinute: 600, evidenceExportsPerDay: 24 };
